...
def create_app():
    ...
    # List the *exact* origins you expect, matching protocol and domain
    allowed_origins = [
        "http://localhost:3000",
        "http://localhost:3001",
        "http://localhost:3002",
    ...
    # Let Flask-CORS handle everything, including preflight (OPTIONS) requests
    CORS(
        app,
    ...
    # If on Render, use sslmode=require
